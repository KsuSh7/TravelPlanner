...
import {View,Text,TextInput,Button,FlatList,TouchableOpacity,Dimensions,StyleSheet,
} from 'react-native';
...
const styles = StyleSheet.create({
    ...
    title: { fontFamily:'Poppins-Bold',fontSize: 30, fontWeight: 'bold',color: '#1B4965',marginBottom: 20,fontFamily: 'Poppins-Bold',            
    },
    ...
    expenseItem: {flexDirection: 'row',justifyContent: 'space-between',paddingVertical: 6,borderBottomWidth: 0.5,borderColor: '#ccc',},
